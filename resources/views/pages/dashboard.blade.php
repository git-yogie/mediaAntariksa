                    ...
                    <div class="card bg-card position-relative overflow-hidden">
                        <div class="card-body" id="card-welcome">
                            ...
                            <div class="row">
                                                ...
                                                <div class="card card-body">
                                                    <div
                                                        ...
                                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                            data-bs-target="#modal-badge">Lihat semua</button>
                                                    </div>
                                                                ...
                                                                <div class="item mx-2" style="width:160px" data-merge="1">
                                                                    <div class="card card-body text-center">
                                                                        ...
                                                                        @if (!$value['get'])
                                                                            ...
                                                                            <div class="progress m-0" role="progressbar"
                                                                                aria-label="Example with label"
                                                                                aria-valuenow="25" aria-valuemin="0"
                                                                                aria-valuemax="100">
                                                                                <div class="progress-bar text-bg-warning"
                                                                                    style="width: {{ $value['percentage'] }}%; height:20px">
                                                                                </div>
                                                                            </div>

                                                                            <small class="text-center m-0 p-0"
                                                                                style="font-size: 10px;">{{ $point }}/{{ $value['minimum_point'] }}
                                                                                ({{ $value['percentage'] }}%)
                                                                            </small>
                                                                        @else
                                                                            <h6
                                ...
                                <div class="col-md-3">
                                    <div
                                        class="card card-body rounded-4 d-flex justify-content-center align-items-center glass-effect border-none">
                                        <div class="relative">
                                            <img src="{{ asset('assets') }}/images/user/avatar-2.jpg" alt=""
                                                class="img-fluid mt-1 img-crop rounded-circle" id="avatar-image">
                                        </div>
                                        ...
                                        <div class="mb-2">
                                            <span class="badge bg-info rounded-pill text-bg-secondary d-inline">#
                                                {{ $rank }}</span>
                                            <span class="badge bg-primary rounded-pill text-bg-primary d-inline"><i
                                                    class='bx bx-coin me-2'></i>{{ Auth::User()->countPoint() }}
                                                pts</span>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets') }}/images/user/avatar-2.jpg"
                                                            ...
                                                            style="height: 30px; width:30px" id="avatar-image">
                                                        {{ $users->name }}
                                                    </td>
                                                    <td class="">
                                                        @php
                            ...
                            @if (isset($value['badge']))
                                ...
                                <div class="card card-body text-center">
                                    ...
                                    @if (!$value['get'])
                                        ...
                                        <small class="text-center m-0 p-0"
                                            style="font-size: 10px;">{{ $point }}/{{ $value['point_minimum'] }}
                                            Point
                                            ({{ $value['percentage'] }}%)
                                        </small>
                                    @else
...
@push('scripts')
    ...
    <script>
        ...
        createStars(100); // jumlah bintang bisa lo sesuaikan

        // Untuk planet, lo bisa tambahin manual, contoh:
        ...
        // Contoh panggil:
        createPlanet('images/welcomepage/1.png', '10%', '80%');
        createPlanet('images/welcomepage/2.png', '20%', '70%');
        createPlanet('images/welcomepage/3.png', '30%', '60%');
        createPlanet('images/welcomepage/4.png', '40%', '50%');
        createPlanet('images/welcomepage/5.png', '90%', '10%', 60);
        createPlanet('images/welcomepage/6.png', '70%', '40%');
        ...
        //     scale: 1.00,
        //     scaleMobile: 1.00,
        //     color: 0xFFFFFF, // warna putih buat bintang
        //     backgroundColor: 0x000011, // sangat gelap kayak luar angkasa
        //     points: 1, // banyak titik biar kaya bintang
        //     maxDistance: 40.00,
        //     spacing: 15.00
        // });
    </script>
